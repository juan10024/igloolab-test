...
* A presentational component with no internal logic.
*/
const ProductItem: React.FC<ProductItemProps> = ({ product, onDelete }) => {
    ...
    return(
        ...
        <div>
            ...
            <p className="text-teal-600 dark:text-teal-400 font-semibold text-lg mt-4">${Number(product.price).toFixed(2)}</p>
        </div>
        <button
